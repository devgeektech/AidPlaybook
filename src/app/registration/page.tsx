...
export default function Page() {
    ...
    const uploadartResponse = async (uploadResponse: any) => {
        saveDataToEmail();
        setUploadFile(false);
        router.push('/key');
    };
    ...
    useEffect(() => {
        if (uploadFile && uploadRef.current) {
    ...
    return (
        <>
            ...
            </div> <div ref={uploadRef}></div>
            {uploadFile && <Uploadart uploadResponse={uploadartResponse} />}
